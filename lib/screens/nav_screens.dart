...
class _NavScreenState extends State<NavScreen> {
  static const double _playerMinhHeight = 60.0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Consumer(
        ...
        return Stack(children: _screens.asMap().map(
              (i, screen) => MapEntry(
            i,
            Offstage
          ...
          Offstage(
            ...
            minHeight: _playerMinhHeight,
            maxHeight: MediaQuery.of(context).size.height,
            builder: (height, percentage){
              if (selectedVideo == null)
                return const SizedBox.shrink();
              if (height <= _playerMinhHeight + 50.0)
              return Container(
